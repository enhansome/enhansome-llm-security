...
* "AgentDojo: A Dynamic Environment to Evaluate Attacks and Defenses for LLM Agents", 2024-06, NeurIPS 24, [\[paper\]](https://www.themoonlight.io/paper/share/5a567ace-0218-4c76-9018-6f99a93df7cd) [\[repo\]](https://github.com/ethz-spylab/agentdojo) ⭐ 804 | 🐛 51 | 🌐 Python | 📅 2026-06-02 [\[site\]](https://agentdojo.spylab.ai/)
...
* [Garak](https://github.com/leondz/garak/) ⭐ 9,123 | 🐛 417 | 🌐 Python | 📅 2026-09-04: a LLM vulnerability scanner ![GitHub Repo stars](https://img.shields.io/github/stars/leondz/garak?style=social)
* [PurpleLlama](https://github.com/facebookresearch/PurpleLlama) ⭐ 4,381 | 🐛 85 | 🌐 Python | 📅 2026-08-18: set of tools to assess and improve LLM security. ![GitHub Repo stars](https://img.shields.io/github/stars/facebookresearch/PurpleLlama?style=social)
...
* [PALLMs (Payloads for Attacking Large Language Models)](https://github.com/mik0w/pallms) ⭐ 146 | 🐛 0 | 📅 2026-01-13
