...
* "LLMmap: Fingerprinting For Large Language Models", 2024-07, [\[paper\]](https://www.themoonlight.io/paper/share/b1223716-8fad-4d90-8a36-cce960514bab) [\[repo\]](https://github.com/pasquini-dario/LLMmap) ⭐ 441 | 🐛 6 | 🌐 Python | 📅 2025-07-24
...
* "AgentDojo: A Dynamic Environment to Evaluate Attacks and Defenses for LLM Agents", 2024-06, NeurIPS 24, [\[paper\]](https://www.themoonlight.io/paper/share/5a567ace-0218-4c76-9018-6f99a93df7cd) [\[repo\]](https://github.com/ethz-spylab/agentdojo) ⭐ 789 | 🐛 46 | 🌐 Python | 📅 2026-06-02 [\[site\]](https://agentdojo.spylab.ai/)
...
* [Garak](https://github.com/leondz/garak/) ⭐ 9,089 | 🐛 412 | 🌐 Python | 📅 2026-08-25: a LLM vulnerability scanner ![GitHub Repo stars](https://img.shields.io/github/stars/leondz/garak?style=social)
* [PurpleLlama](https://github.com/facebookresearch/PurpleLlama) ⭐ 4,375 | 🐛 84 | 🌐 Python | 📅 2026-08-18: set of tools to assess and improve LLM security. ![GitHub Repo stars](https://img.shields.io/github/stars/facebookresearch/PurpleLlama?style=social)
